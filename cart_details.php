<?php
	...
	if(isset($_SESSION['user'])){
		...
		try{
			...
			$output .= "
				<tr>
					<td colspan='5' align='right'><b>รวมทั้งหมด $total บาท</b></td>
				<tr>
			";
		...
		if(count($_SESSION['cart']) != 0){
			...
			foreach($_SESSION['cart'] as $row){
				...
				$output .= "
					<tr>
						...
						<td>".number_format($subtotal)." บาท</td>
					</tr>
				";
			...
			$output .= "
				<tr>
					...
					<td><b>".number_format($total)."</b> บาท</td>
				<tr>
			";
		}
			...
			$output .= "
				<tr>
					<td colspan='6' align='center'>ไม่มีสินค้าในตระกล้า</td>
				<tr>
			";
		}
