...
<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-mini"><b>W</b>TM</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>Watashitachi</b>Manga</span>
  </a>
  ...
  <nav class="navbar navbar-static-top">
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        <!-- dropdown ดูชื่อUser และ update กับ lockout -->
    ...
    <!-- end dropdown ดูชื่อUser และ update กับ lockout -->
  </nav>
</header>

<?php include 'includes/profile_modal.php';  /* เช็คแล้ว */?>