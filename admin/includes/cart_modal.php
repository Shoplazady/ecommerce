...
<div class="modal fade" id="confirm">
    <div class="modal-dialog">
        <div class="modal-content text-center">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="cart_confirm.php">
                <input type="hidden" class="cartid" name="cartid">
                <input type="hidden" class="userid" name="userid">
                <div class="form-group">

                <h2>ยืนยันการเติมเหรียญ</h2>
                <input type="hidden" class="form-control" name="pay" value="จ่ายแล้ว">
                    
                </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              <button type="submit" class="btn btn-success btn-flat" name="confirm"><i class="fa fa-check-square-o"></i> ยืนยัน</button>
              </form>
            </div>
        </div>
    </div>
