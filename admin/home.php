...
<?php include 'includes/header.php'; /* เช็คดูแล้ว */ ?>

<body class="hold-transition skin-blue sidebar-mini">
<div class="wrapper">

  <?php include 'includes/navbar.php';  /* เช็คดูแล้ว */ ?>

  <?php include 'includes/menubar.php'; /* เช็คดูแล้ว */ ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- chart เปรียบเทียบยอดขายแต่ละเดือน  -->
      <!-- /.row -->
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
      ...
      <!-- end chart เปรียบเทียบยอดขายแต่ละเดือน  -->
      </section>
      <!-- right col -->
    </div>
