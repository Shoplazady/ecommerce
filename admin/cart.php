...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo  'ตระกล้าสั่งซื้อเหรียญของ '.$user['firstname'].' '.$user['lastname'] ?>
      </h1>
      <ol class="breadcrumb">
                      ...
                      foreach($stmt as $row){
                        echo "
                          <tr>
                            ...
                            <td>".$row['quantity']."</td>
                            <td>
                              <button class='btn btn-success btn-sm confirm btn-flat' data-id='".$row['cartid']."'><i class='fa fa-check-square-o'></i> ยืนยัน</button>
                              <button class='btn btn-warning btn-sm edit btn-flat' data-id='".$row['cartid']."'><i class='fa fa-edit'></i> Edit Quantity</button>
